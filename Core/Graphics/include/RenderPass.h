...
public:
    ...
    std::vector<VkSemaphore>& GetPresentSemaphores() { return presentCompleteSemaphores; }
    std::vector<VkSemaphore>& GetRenderSemaphores() { return renderCompleteSemaphores; }
    std::vector<VkCommandBuffer>& GetGraphicCommandBuffers() { return graphicCommandBuffers; }
